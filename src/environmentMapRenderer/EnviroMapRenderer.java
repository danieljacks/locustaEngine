...
public class EnviroMapRenderer {
	...
	public static void renderEnvironmentMap(ModelTexture cubeMap, Scene scene, Vector3f center, MasterRenderer renderer) {
		...
		for (int i = 0; i < 6; i++) {
			...
			GL30.glFramebufferTexture2D(GL30.GL_FRAMEBUFFER, GL30.GL_COLOR_ATTACHMENT0,
					GL13.GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, cubeMap.getID(), 0);
		...
		GL11.glBindTexture(GL13.GL_TEXTURE_CUBE_MAP, cubeMap.getID());
